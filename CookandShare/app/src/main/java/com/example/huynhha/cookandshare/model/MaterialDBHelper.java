...
public class MaterialDBHelper extends SQLiteOpenHelper{
    ...
    public static final String DATABASE_NAME = "MaterialMarket.db";

    public MaterialDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
